...
print('%s  %s' % (RR, W))
algorithm1 = input('%s    %s%s[%s#%s%s] Algorithm:%s ' % (RR, W, B, R, W, B, O))
if algorithm1.strip() in 'md5 MD5 Md5 mD5'.split():
    print('%s%s  %s' % (W, RR, W))
    hash = hashlib.md5(input('%s    %s%s[%s#%s%s] String:%s ' % (RR, W, B, R, W, B, O))).hexdigest()
    hash = hash.upper()
    print('%s%s  %s' % (W, RR, W))
    ...
    print('%s%s  %s' % (W, RR, W))
    hash = hashlib.sha1(input('%s    %s%s[%s#%s%s] String:%s ' % (RR, W, B, R, W, B, O))).hexdigest()
    hash = hash.upper()
    print('%s%s  %s' % (W, RR, W))
    print('%s    %s%s[%s+%s%s] Hash: %s%s' % (RR, W, B, R, W, B, O, hash))
    print('%s' % W)
    ...
    print('%s%s  %s' % (W, RR, W))
    hash = hashlib.sha224(input('%s    %s%s[%s#%s%s] String:%s ' % (RR, W, B, R, W, B, O))).hexdigest()
    hash = hash.upper()
    print('%s%s  %s' % (W, RR, W))
    print('%s    %s%s[%s+%s%s] Hash: %s%s' % (RR, W, B, R, W, B, O, hash))
    print('%s' % W)
    ...
    print('%s%s  %s' % (W, RR, W))
    hash = hashlib.sha256(input('%s    %s%s[%s#%s%s] String:%s ' % (RR, W, B, R, W, B, O))).hexdigest()
    hash = hash.upper()
    print('%s%s  %s' % (W, RR, W))
    print('%s    %s%s[%s+%s%s] Hash: %s%s' % (RR, W, B, R, W, B, O, hash))
    print('%s' % W)
    ...
    print('%s%s  %s' % (W, RR, W))
    hash = hashlib.sha384(input('%s    %s%s[%s#%s%s] String:%s ' % (RR, W, B, R, W, B, O))).hexdigest()
    hash = hash.upper()
    print('%s%s  %s' % (W, RR, W))
    print('%s    %s%s[%s+%s%s] Hash: %s%s' % (RR, W, B, R, W, B, O, hash))
    print('%s' % W)
    ...
    print('%s%s  %s' % (W, RR, W))
    hash = hashlib.sha512(input('%s    %s%s[%s#%s%s] String:%s ' % (RR, W, B, R, W, B, O))).hexdigest()
    hash = hash.upper()
    print('%s%s  %s' % (W, RR, W))
    print('%s    %s%s[%s+%s%s] Hash: %s%s' % (RR, W, B, R, W, B, O, hash))
    print('%s' % W)
