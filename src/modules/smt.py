...
info = {
        ...
        "desc": "A suite of tools for hacking a target's social media account.", # Brief description
        ...
        "lastupdate": "May 01, 2018",                     # a website of the author.
 ...
 Social Media Toolkit
    ...
    while True:
        try:
            ...
            print()
            print(SMT.format(info['version']))
            print()
            print("[01] Facebook Attacks")
            print("[02] Twitter Attacks")
            print("[03] Instagram Attacks")
            print()
            print("[99] Quit SMToolkit")
            main_input = int(input(" [SMTOOLKIT]: "))
            if main_input == 1:
