...
info = {
        "name": "Cisco Auditing Tool (CAT)", # Module filename (Change this; I recommend you to use the filename as the module name.)
        "version": "4.0", # version
...
dependencies = ['BINARY: Perl 5.26.1', 'PERL: Getopt::Std'] # Put needed dependencies here.  
module_status = 0
category = ['cisco', 'audit', 'g0ne', 'null0', 'network', 'perl']
...
def module_body(current_user, __MODULE_PATH__, __OUTPUT_PATH__, SESSION_ID, USERLEVEL, debugging):
    ...
    print()
    print("***********************")
    print("* CISCO AUDITING TOOL *")
    print("***********************")
    print()
    TARGET = input("Target Host: ")
    PORT = input("Target Port (Default: 23): ")
    WLCN = input("Wordlist for community name guessing: ")
    WLPW = input("Wordlist for password guessing: ")
