...
info = {
        "name": "ShadowCrack", # Module filename (Change this; I recommend you to use the filename as the module name.)
        "version": "1.5", # version
        "author": "Shadow Team", # Author
        "desc": "A hashing tool used to encrypt strings and/or crack hashes.", # Brief description
        "email": "Public.ShadowTeam@gmail.com", # Email
        "authorinfo": "https://github.com/Sh4d0w-T34m/", # Additional information about the author; this could be
        "lastupdate": "Mar. 10, 2018",                     # a website of the author.
...
def module_body():
    ...
    os.system("cd modules/SHADOWCRACK && python2 ShadowCrack.py")
    os.system("cd ../..")
