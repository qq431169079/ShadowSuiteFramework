# Shadow Suite Framework 0.1.0.4 :: Ethical Hacking Toolkit and Framework
...
+ [MAINTENANCE]: Installation of modules via ZIP archive (for modules with subdirectories)
